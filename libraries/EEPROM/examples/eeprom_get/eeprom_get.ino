/*
 @file   eeprom_get.ino
 @brief  This demo shows how to use the EEPROM.get() method. 
 ...
 * 
 * Note: To pre-set the EEPROM data, run the example sketch eeprom_put.
 *       This sketch will run without it, however, the values shown
 *       will be shown from what ever is already on the EEPROM.
 *       This may cause the serial object to print out a large string of
 *       garbage if there is no null character inside one of the strings loaded.
*/
...
void setup() {
  ...
  /*
    ...
    - Get can be used with custom structures too. I have separated this into an extra function.
  */
