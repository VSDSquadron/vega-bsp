/*
   ...
   *  Library Name : Adafruit_ST7735_and_ST7789_Library (Download from gitlab)
 ...
 * For connecting to port 1 (MOSI 1 and SCLK 1) of aries board use the default variable SPIClass SPI(1) instead ofSPIClass SPI(0);  
